...
describe('init command', () => {
  ...
  it('should initialize a skill and create SKILL.md', () => {
    ...
    expect(output).toMatchInlineSnapshot(`
      ...
      Publishing:
        GitHub:  Push to a repo, then npx skilldirs add <owner>/<repo>
        URL:     Host the file, then npx skilldirs add https://example.com/my-test-skill/SKILL.md
  ...
  it('should init SKILL.md in cwd when no name provided', () => {
    ...
    expect(output).toContain('npx skilldirs add <owner>/<repo>');
    expect(output).toContain('URL:');
    expect(output).toContain('npx skilldirs add https://example.com/SKILL.md');
  ...
  it('should show publishing hints with skill path', () => {
    ...
    expect(output).toContain('Publishing:');
    expect(output).toContain('GitHub:  Push to a repo, then npx skilldirs add <owner>/<repo>');
    expect(output).toContain(
      'URL:     Host the file, then npx skilldirs add https://example.com/my-skill/SKILL.md'
    );
  });
