...
describe('skills CLI', () => {
  describe('--help', () => {
    it('should display help message', () => {
      ...
      expect(output).toContain('Usage: skilldirs <command> [options]');
  ...
  describe('no arguments', () => {
    it('should display banner', () => {
      ...
      expect(output).toContain('npx skilldirs add');
      expect(output).toContain('npx skilldirs update');
      expect(output).toContain('npx skilldirs init');
