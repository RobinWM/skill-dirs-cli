...
# Any git URL
npx skilldirs add git@github.com:RobinWM/ship-skills.git
...
npx skilldirs add RobinWM/ship-skills --agent '*' --skill frontend-design
```
...
INSTALL_INTERNAL_SKILLS=1 npx skilldirs add RobinWM/ship-skills --list
```
...
- [Vercel Agent Skills Repository](https://github.com/RobinWM/ship-skills)
