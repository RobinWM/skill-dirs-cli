...
`
  ...
  describe('help output', () => {
    ...
    it('should include list examples in help', () => {
      const result = runCli(['--help']);
      expect(result.stdout).toContain('skilldirs list');
      expect(result.stdout).toContain('skilldirs ls -g');
      expect(result.stdout).toContain('skilldirs ls -a claude-code');
    });
  });
  ...
  describe('banner', () => {
    it('should include list command in banner', () => {
      const result = runCli([]);
      expect(result.stdout).toContain('npx skilldirs list');
      expect(result.stdout).toContain('List installed skills');
    });
  });
});
