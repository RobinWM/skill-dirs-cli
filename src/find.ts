...
${DIM}  1) npx skilldirs find [query]${RESET}
${DIM}  2) npx skilldirs add <owner/repo@skill>${RESET}`;
  ...
  if (query) {
    ...
    console.log(`${DIM}Install with${RESET} npx skilldirs add <owner/repo@skill>`);
    console.log();
